local on_attach = function(client, bufnr)
	...
	vim.keymap.set('n', 'gw', require('telescope.builtin').grep_string, { desc = 'Grep Word under cursor' })
...
return {
	...
	},
	{
		...
		opts = {
			formatters_by_ft = {
				cpp = { { "clang-format", range = true } },
				c = { { "clang-format", range = true } },
				lua = { { "stylua", range = true } }
			},
			--			format_on_save = {
			--				timeout_ms = 500,
			--				lsp_fallback = true,
